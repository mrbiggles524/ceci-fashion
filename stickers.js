...
window.CECI_STICKERS = {
  ...
  items: [
    { id: "bow-satin", cat: "bows", name: "Satin Bow", w: 56, svg: `<svg viewBox="0 0 64 48" xmlns="http://www.w3.org/2000/svg"><path d="M32 22 L8 8 Q4 24 8 40 L32 26 Z" fill="#ff9ec4"/><path d="M32 22 L56 8 Q60 24 56 40 L32 26 Z" fill="#e84393"/><circle cx="32" cy="24" r="7" fill="#ff6eb4"/><circle cx="32" cy="24" r="4" fill="#ffc8e0"/></svg>` },
